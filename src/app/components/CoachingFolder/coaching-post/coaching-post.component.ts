...
@Component({
  selector: 'app-coaching-post',
  templateUrl: './coaching-post.component.html',
  styleUrls: ['./coaching-post.component.scss']
})
export class CoachingPostComponent {
  ...
  private URL: string = "http://localhost:8080/coaching/post";
